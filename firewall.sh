...
# Limpando as Chains
 ...
 iptables -t mangle -F
 iptables -X
 echo "Chains limpos e OK";
 echo "Zerando contadores";
 # Zerando contadores
 iptables -Z
 iptables -t nat -Z
 iptables -t mangle -Z
 echo "Contadores Zerados";
 echo "Definindo Polticas Padrões";
 # Define politicas padrao ACCEPT
 iptables -P INPUT ACCEPT
 iptables -P OUTPUT ACCEPT
 iptables -P FORWARD ACCEPT
 echo "Polticas Padrões definidas";
 echo "Liberando trafico em loopback";
# Allow traffic on loopback
iptables -A INPUT -i lo -j ACCEPT
iptables -A OUTPUT -o lo -j ACCEPT
echo " trafico em loopback liberado";
echo "Liberando conecções estabelicidas"
# Allow all inbound established connections
iptables -A INPUT -m state --state RELATED,ESTABLISHED -j ACCEPT
echo "conecções estabelicidas liberadas"
# Allow all outbound established connections
echo "Allow all outbound established connections"
iptables -A OUTPUT -m state --state RELATED,ESTABLISHED -j ACCEPT
echo "established connections outbond"
echo "Abrindo Portas para a internet"
...
echo "Porta Aberta para SSH OK"
echo "Rediecionamento de Portas 80 para 8080"
# Redirect 8080 to 80
...
echo "Adcionado Portas 80 para 8080 e OK"
echo "Liberando Samba portas padores Rede "
...
echo "Portas Liberadas SAMBA 137 138 139 e 445 "
echo "Liberando OPENVPN"
#VPN
...
echo " OPENVPN Liberado e OK"
echo " Liberando Portas Alternativas para FTP usando 2121"
#FTP
...
echo " Porta alternativa liberada FTP 21 para redirecionada 2121"
echo " Ignorando pings ICMP"
# Ignora pings
echo "1" > /proc/sys/net/ipv4/icmp_echo_ignore_all
echo " Proteções diversas contra portscanners, ping of death, ataques DoS, etc."
...
echo "Permitindo o estabelecimento de novas conexões iniciadas por você coração do firewall "
